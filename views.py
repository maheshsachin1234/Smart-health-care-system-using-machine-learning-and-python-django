...
def prediction(request):
    ...
    # Training data
    path_train = "C:/MAJOR PROJ/smart-healthcare-system-master/smart-healthcare-system-master/predict/templates/predict/Training.csv"
    data_training = pd.read_csv(path_train)
    path_test = "C:/MAJOR PROJ/smart-healthcare-system-master/smart-healthcare-system-master/predict/templates/predict/Testing.csv"
